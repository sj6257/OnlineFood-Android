...
public class OnlineOrderingDataBaseOpenHelper extends SQLiteOpenHelper 
{

	private static String TAG = "DataBaseHelper"; // Tag just for the LogCat window 	 
	private static String DB_PATH = "";           // destination path (location) of our database on device
	private static String DB_NAME ="Online_Order_Temp.db";       // Database name 
	private SQLiteDatabase mDataBase;             // Database Variable
	private final Context mContext;               // Context Variable
	private final static int DB_VERSION=4;          // Database Version

	// constructor for the OnlineOrderingDataBaseOpenHelper class

	public OnlineOrderingDataBaseOpenHelper(Context context)  
	{ 
